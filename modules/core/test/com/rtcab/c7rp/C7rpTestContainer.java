...
public class C7rpTestContainer extends TestContainer {

    public C7rpTestContainer() {
        super();
    ...
    public static class Common extends C7rpTestContainer {

        public static final C7rpTestContainer.Common INSTANCE = new C7rpTestContainer.Common();
